...
# version 2 for DINGO pilot phase II observations (no dithered data)
#
...
# To run:
#
# python DINGO_specline_qa_v2.py -s 10991 -c
#
...
#
# Major updated for DINGO pilot phase II on 30 September 2021 by Jonghwan Rhee
#
################################################################################
...
def get_HIPASS(pos_cen, dRA, dDec, band):
    ...
    if band == 2:
        ...
        with open(fig_dir + '/' + hipass_cat, 'w') as f:
            print('No HIPASS sources in band 1', file=f)
...
mad_rms, med_madfm = cal_mosaic_Stats(cubestat_linmos_contsub[0])
n_bad_chan, mosaic_bad_chan, QC_badchan_id = qc_Bad_Chans(cubestat_linmos_contsub[0], med_madfm)
...
hipass_cat = get_HIPASS(field_cen, size_ra, size_dec, band)
